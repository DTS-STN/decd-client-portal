    ...
    <div className="bg-deep-blue-solid text-white py-2.5">
      <div className="layout-container flex justify-between items-center">
        ...
        <div className="hidden font-body text-sm md:flex md:items-center">
          <Dropdown text={t('common:nav_link_services')} />
          <Dropdown text={t('common:nav_link_life_journey')} />
          <Dropdown text={t('common:nav_link_contact')} />
        </div>
        <Link key="" href="/">
          <a className="hidden font-body text-sm md:block">
            {t('common:logout')}
          </a>
        </Link>
